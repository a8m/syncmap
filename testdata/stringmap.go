...
// from the dirty map.
var expungedStringMap = unsafe.Pointer(new(interface{}))
...
func newEntryStringMap(i interface{}) *entryStringMap {
...
func (m *StringMap) Load(key string) (value interface{}, ok bool) {
...
func (e *entryStringMap) load() (value interface{}, ok bool) {
...
func (m *StringMap) Store(key string, value interface{}) {
	read, _ := m.read.Load().(readOnlyStringMap)
...
// unchanged.
func (e *entryStringMap) tryStore(i *interface{}) bool {
	for {
		p := atomic.LoadPointer(&e.p)
...
func (e *entryStringMap) storeLocked(i *interface{}) {
...
func (m *StringMap) LoadOrStore(key string, value interface{}) (actual interface{}, loaded bool) {
...
func (e *entryStringMap) tryLoadOrStore(i interface{}) (actual interface{}, loaded, ok bool) {
	p := atomic.LoadPointer(&e.p)
	if p == expungedStringMap {
...
func (m *StringMap) LoadAndDelete(key string) (value interface{}, loaded bool) {
	read, _ := m.read.Load().(readOnlyStringMap)
	e, ok := read.m[key]
	if !ok && read.amended {
		m.mu.Lock()
...
func (e *entryStringMap) delete() (value interface{}, ok bool) {
	for {
		p := atomic.LoadPointer(&e.p)
		if p == nil || p == expungedStringMap {
			return value, false
...
func (m *StringMap) Range(f func(key string, value interface{}) bool) {
